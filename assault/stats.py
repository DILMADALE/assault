...
class Results:
    ...
    def __init__(self, total_time: float, requests: List[Dict]):
        ...
        self.requests = sorted(requests, key=lambda r: r["request time"])
    ...
    def slowest(self) -> float:
        ...
        6.1
        """
        return self.requests[-1]["request time"]
    ...
    def fastest(self) -> float:
        ...
        1.04
        """
        return self.requests[0]["request time"]
    ...
    def average_time(self) -> float:
        ...
        3.513333333333333
        """
        return mean([r["request time"] for r in self.requests])

    def successful_requests(self) -> int:
        """
        Returns the number of successful request
        ...
        2
        """
        return len([r for r in self.requests if r["status code"] in range(200, 299)])
